define(['jquery', 'bootstrap', 'backend', 'form', 'table'], function ($, undefined, Backend, Form, Table) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'content/attachment/index',
                    add_url: 'content/attachment/add',
                    edit_url: 'content/attachment/edit',
                    del_url: 'content/attachment/del',
                    multi_url: 'content/attachment/multi',
                    table: 'attachment'
                }
            });
