<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"/Applications/EasySrv/www/fastadmin/public/../application/admin/view/content/cate/add.html";i:1702712771;s:78:"/Applications/EasySrv/www/fastadmin/application/admin/view/layout/default.html";i:1689345038;s:75:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/meta.html";i:1689345038;s:77:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/script.html";i:1689345038;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--    </div>-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-nickname" data-rule="required" class="form-control" name="row[show_num]" type="text" value="5">
        </div>
    </div>
