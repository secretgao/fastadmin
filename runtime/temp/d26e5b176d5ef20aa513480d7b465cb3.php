<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"/Applications/EasySrv/www/fastadmin/public/../application/admin/view/content/news/add.html";i:1689519638;s:78:"/Applications/EasySrv/www/fastadmin/application/admin/view/layout/default.html";i:1689345038;s:75:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/meta.html";i:1689345038;s:77:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/script.html";i:1689345038;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--                    <span><button type="button" id="fachoose-avatar" class="btn btn-primary fachoose" data-input-id="c-avatar" data-mimetype="image/*" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avatar" data-rule="" class="form-control" size="50" name="row[avatar]" type="hidden" value="">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-avatar" class="btn btn-danger faupload" data-input-id="c-avatar" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-preview-id="p-avatar"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <!--                    <span><button type="button" id="fachoose-avatar" class="btn btn-primary fachoose" data-input-id="c-avatar" data-mimetype="image/*" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>-->
                </div>
