<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Applications/EasySrv/www/fastadmin/public/../application/admin/view/content/attachment/add.html";i:1689521497;s:78:"/Applications/EasySrv/www/fastadmin/application/admin/view/layout/default.html";i:1689345038;s:75:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/meta.html";i:1689345038;s:77:"/Applications/EasySrv/www/fastadmin/application/admin/view/common/script.html";i:1689345038;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <div class="col-xs-12 col-sm-8">
            <input type="hidden" name="row[local]" id="c-local" class="form-control"/>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div style="width:180px;display:inline-block;">
                <select name="category-local" id="category-local" class="form-control selectpicker">
                    <option value="categoryHead">轮播图</option>
                </select>
            </div>
